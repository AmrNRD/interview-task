...
return [
    ...
    */
    ...
    'namespaces' => [
        'models' => [
            '\App\Module\User\Entities',
		'\App\Module\Dashboard\Entities',
		'\App\Module\Store\Entities',
		'\App\Module\Product\Entities',
		'\App\Module\Cart\Entities',
		###DOMAIN\ENTITY###
        ],
        'queries' => [
            '\App\Module\User\Graphql\Queries',
		'\App\Module\Dashboard\Graphql\Queries',
		'\App\Module\Store\Graphql\Queries',
		'\App\Module\Product\Graphql\Queries',
		'\App\Module\Cart\Graphql\Queries',
		###DOMAIN\QUERY###
        ],
        'mutations' => [
            '\App\Module\User\Graphql\Mutations',
		'\App\Module\Dashboard\Graphql\Mutations',
		'\App\Module\Store\Graphql\Mutations',
		'\App\Module\Product\Graphql\Mutations',
		'\App\Module\Cart\Graphql\Mutations',
		###DOMAIN\MUTATION###
        ],
        'subscriptions' => [
            '\App\Module\User\Graphql\Subscriptions',
		'\App\Module\Dashboard\Graphql\Subscriptions',
		'\App\Module\Store\Graphql\Subscriptions',
		'\App\Module\Product\Graphql\Subscriptions',
		'\App\Module\Cart\Graphql\Subscriptions',
		###DOMAIN\SUBSCRIPTION###
        ],
        'interfaces' => [
            '\App\Module\User\Graphql\Interfaces',
		'\App\Module\Dashboard\Graphql\Interfaces',
		'\App\Module\Store\Graphql\Interfaces',
		'\App\Module\Product\Graphql\Interfaces',
		'\App\Module\Cart\Graphql\Interfaces',
		###DOMAIN\INTERFACE###
        ],
        'unions' => [
            '\App\Module\User\Graphql\Unions',
		'\App\Module\Dashboard\Graphql\Unions',
		'\App\Module\Store\Graphql\Unions',
		'\App\Module\Product\Graphql\Unions',
		'\App\Module\Cart\Graphql\Unions',
		###DOMAIN\UNION###
        ],
        'scalars' => [
            '\App\Module\User\Graphql\Scalars',
		'\App\Module\Dashboard\Graphql\Scalars',
		'\App\Module\Store\Graphql\Scalars',
		'\App\Module\Product\Graphql\Scalars',
		'\App\Module\Cart\Graphql\Scalars',
		###DOMAIN\SCALAR###
        ],
        'directives' => [
            '\App\Module\User\Graphql\Directives',
		'\App\Module\Dashboard\Graphql\Directives',
		'\App\Module\Store\Graphql\Directives',
		'\App\Module\Product\Graphql\Directives',
		'\App\Module\Cart\Graphql\Directives',
		###DOMAIN\DIRECTIVE###
        ],
    ],
